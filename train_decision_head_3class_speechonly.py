...
def main() -> None:
    ...
    p.add_argument("--out-dir", default="checkpoints/m4_decision_head_3class_speechonly")
    ...
    sf_train, y_train = load_cache(os.path.join(args.ckpt_dir, "train_bothpresent_cache.pt"))
    sf_test, y_test = load_cache(os.path.join(args.ckpt_dir, "test_bothpresent_cache.pt"))
