...
during training (test_bothpresent_cache.pt -- guarantees the eval set
...
def main() -> None:
    ...
    p.add_argument("--out", default="checkpoints/m4_decision_head_3class_bothpresent/A1_FALSIFIER_RESULTS.json")
    ...
    train_cache_path = os.path.join(args.ckpt_dir, "train_bothpresent_cache.pt")
    ...
    test_cache_path = os.path.join(args.ckpt_dir, "test_bothpresent_cache.pt")
